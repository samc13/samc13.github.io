...
- [`@tanstack/react-table`](https://tanstack.com/table/latest) a headless UI library that comes equipped with sorting/filtering/grouping/pagination all out of the box
